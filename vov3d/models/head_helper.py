...
class V3DHead(nn.Module):
    ...
    def __init__(
        ...
        self.inplace_relu = inplace_relu
        self.bn_lin5_on = bn_lin5_on
        self._construct_head(dim_in, dim_out, norm_module)

    def _construct_head(self, dim_in, dim_out, norm_module):
