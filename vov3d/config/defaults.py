...
_C.VOV3D = CfgNode()
_C.VOV3D.DEPTH = 19
_C.VOV3D.TRANS_FUNC = "OSA_transform"
_C.VOV3D.NUM_CONV = 5
_C.VOV3D.INNER_CH = 64

# Dimensions of the last linear layer before classificaiton.
_C.VOV3D.DIM_C5 = 2048

# Whether to use a BatchNorm (BN) layer before the classifier, default is false.
_C.VOV3D.BN_LIN5 = False

# Size of dilation on different res stages.
_C.VOV3D.TEMPORAL_DILATIONS = [[2], [2], [2], [2]]

# Size of dilation on different res stages.
_C.VOV3D.SPATIAL_STRIDES = [[2], [2], [2], [2]]

_C.VOV3D.INNER_MULTIPLIER = [1, 2, 4, 8]

_C.VOV3D.OUT_MULTIPLIER = [0.5, 1.0, 2, 4]
...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["c2d", "i3d", "slow", "x3d", "vov3d"]
